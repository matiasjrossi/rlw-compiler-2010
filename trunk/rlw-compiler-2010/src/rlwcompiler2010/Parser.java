...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Nov 14 20:20:12 ART 2010
  */
		...
		Object c = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 ...
		 Logger.get().logDebug("Parser", "Using rule: block ::= statement"); 
          ...
          case 29: // selection ::= IF LBRACKET predicate RBRACKET block ELSE block 
            {
              Object RESULT =null;
		 Logger.get().logDebug("Parser", "Using rule: selection ::= IF LBRACKET predicate RBRACKET block ELSE block"); ParserHelper.get().iF(); 
